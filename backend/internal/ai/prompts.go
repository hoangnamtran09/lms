...
**Định dạng Output (JSON):**
{
  ...
  "nodes": [
    {"id": "c1", "label": "Khái niệm chính 1", "type": "concept"},
    {"id": "c1_s1", "label": "Ý phụ 1.1", "type": "subtopic"},
    {"id": "c1_s1_d1", "label": "Chi tiết cụ thể", "type": "detail"},
    {"id": "c2", "label": "Khái niệm chính 2", "type": "concept"}
  ],
  "edges": [
...
**Định dạng Output (JSON):**
{
  ...
  "nodes": [
    {"id": "n1", "label": "Khái niệm A", "type": "concept"},
    {"id": "n2", "label": "Khái niệm B", "type": "concept"}
  ],
  "edges": [
